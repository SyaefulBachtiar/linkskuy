...
export default function SideBar({isLayanan, isTemplate, isDashboard, currentUser, handleLogout, menuActive}) {
    ...
    return (
      <div className="block sm:block md:hidden lg:hidden xl:hidden h-screen bg-gray-700">
        <div
          className={`absolute top-20 right-0 flex justify-end transition-transform duration-300 ease-in-out transform ${
        ...
        >
          ...
          >
            <div className="w-[400px] h-screen sidebar-background"></div>
            <ul className="font-montserrat flex flex-col gap-3 h-screen w-[400px] text-white absolute top-0 -left-0 p-10">
              {currentUser ? (
                <>
